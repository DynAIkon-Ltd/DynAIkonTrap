    ...
    try:
        with open(shell_path, 'w') as fov_file:
            fov_file.write(
                ...
                <body> 
                <div class="d-flex justify-content-center">
                <iframe src="http://{ip_addr}:{port}/" style="position:fixed; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;">
