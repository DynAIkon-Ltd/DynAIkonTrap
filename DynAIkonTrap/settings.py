...
class CameraSettings:
    """Settings for a `DynAIkonTrap.camera.Camera`"""
...
class MotionFilterSettings:
    """Settings for a `DynAIkonTrap.filtering.motion.MotionFilter`"""
...
class MotionQueueSettings:
    """Settings for a `DynAIkonTrap.filtering.motion_queue.MotionQueue`"""
...
class FilterSettings:
    """Settings for a `DynAIkonTrap.filtering.filtering.Filter`"""
